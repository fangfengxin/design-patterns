<jsp:useBean id="beatModel" scope="request" class="compound.djview.BeatModel"/>
<!DOCTYPE>
<html lang="en">
<head>
    <title>DJ View</title>
...
<form method="get" action="DJViewServlet">
    BPM: <label><input type=text name="bpm"
           value="<jsp:getProperty name='beatModel' property='BPM' />"></label>
    &nbsp;
